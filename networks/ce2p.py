# -*- coding: utf-8 -*-
# @Author: luoling
# @Date:   2019-12-03 17:49:08
# @Last Modified by:   luoling
# @Last Modified time: 2019-12-10 17:50:07
...
class EdgeModule(nn.Module):
    ...
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        ...
        self.conv5 = nn.Conv2d(
            out_fea * 3, out_fea, kernel_size=1, padding=0, bias=True)
...
def CE2P(num_classes=19, url=None, pretrained=True):
    ...
    if pretrained:
        saved_state_dict = torch.load(url)
        # saved_state_dict = model_zoo.load_url(model_urls['resnet101'])
